...
<body class="bg-gray-200">
    ...
    <div class="ml-64 mt-[80px] p-6">
        ...
        <!-- User Management -->
        <div id="userManagementSection" class="bg-white shadow-md rounded-lg p-6 mb-6 hidden">
            <h2 class="text-xl font-bold mb-4">User Management</h2>
            <button onclick="openModal('userModal')" class="bg-blue-600 text-white px-4 py-2 rounded mb-4">➕ Add
                User</button>
